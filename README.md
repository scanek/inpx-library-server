...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-2.6.5-a1671b?style=flat-square&labelColor=1e1a16" alt="Version 2.6.5">
</p>
...
- 📴 **Офлайн-режим читалки (PWA Offline Reading)**: веб-читалка со всеми компонентами Foliate и открываемыми книгами автоматически кэшируется в Service Worker (`inpx-books-v1`). Можно спокойно продолжать читать книги в самолёте, метро или при временном отключении сервера без интернета.
- ⚡ **Быстрое сканирование папок (Fast Folder Scan)**: новый режим сканирования без распаковки архивов (автор и название определяются из имён файлов). Ускоряет индексацию больших коллекций без INPX в сотни раз!
- 📲 **Отправка книги в Telegram в 1 клик**: в карточке книги появилась кнопка быстрой отправки книги прямо в личный чат Telegram через настроенного бота.
...
- 📚 **«Всеядная» авто-детекция раздач (RuTracker / любые коллекции)**:
  ...
  - Пакетное добавление всех найденных баз в один клик («➕ Добавить сразу все базы»).
